...
FUNCTION LOG_A_SUM_INIT(M,EPS)
  ...
  COMPLEX(KIND(1.0D0))  :: ONE_MEPS_MM,LOG_A_SUM_INIT,LOG_GAMMA
  !
...
FUNCTION HYP_PS_ONE(A,B,C,MZP1)
  ...
  COMPLEX(KIND(1.0D0))  :: B_EXTRA_TERM,B_TERM,B_SUM,GAMMA_C,LOG_GAMMA,RATIO
...
FUNCTION HYP_PS_INFINITY(A,B,C,Z)
  ...
  INTEGER(IPR) :: N,M,PHASE,M_M2,MIN_N,MIN_N_CALC,M_P1
  REAL(KIND(1.0D0))     :: B_PREC,N_P1,N_PM_P1,CV_POLY_DER_CALC
  COMPLEX(KIND(1.0D0))  :: B_SUM_INIT_PS_INFINITY,LOG_GAMMA,POW_Z_INV_M
...
RECURSIVE FUNCTION HYP_2F1(A,B,C,Z) RESULT(RES)
  ...
  COMPLEX(KIND=8)  :: RES,HYP_PS_INFINITY,HYP_PS_ZERO,Z_SHIFT
